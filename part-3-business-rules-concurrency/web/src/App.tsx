...
import { BidRuleError, type AuctionCategory, type AuctionItem, type DemoIdentity, auctionCategories, createAuction, demoIdentities, fetchAuction, fetchAuctions, formatCurrency, formatTimeLeft, placeBid } from './catalog';
...
function useAuction(id: number | null, refreshToken = 0): Loadable<AuctionItem> & { replaceData: (auction: AuctionItem) => void } {
  ...
  return {
    ...state,
    replaceData: (auction) => setState({ data: auction, error: null }),
  };
}
